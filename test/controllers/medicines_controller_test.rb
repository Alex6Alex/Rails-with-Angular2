...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create medicine' do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { classification: @medicine.classification, comment: @medicine.comment, form: @medicine.form, name: @medicine.name, package: @medicine.package } }
    end
  ...
  test 'should update medicine' do
    patch medicine_url(@medicine), params: { medicine: { classification: @medicine.classification, comment: @medicine.comment, form: @medicine.form, name: @medicine.name, package: @medicine.package } }
